  ...
  return (
    <>
      ...
      <div className="bg-gradient-to-br from-white via-slate-50/50 to-blue-50/30 rounded-3xl shadow-2xl shadow-blue-900/10 overflow-hidden border border-slate-200/50 backdrop-blur-sm">
        ...
        <div className="relative px-8 py-6 bg-gradient-to-r from-orange-500 via-indigo-600 to-purple-600 gradient-animate text-white overflow-hidden">
          {/* Decorative elements */}
            ...
            <div className="relative">
              ...
              {nextStep.status === 'pending' && (
                <button
                  ...
                  className="mt-4 px-6 py-2.5 bg-gradient-to-r from-orange-500 to-orange-700 text-white text-sm font-bold rounded-xl hover:from-blue-700 hover:to-indigo-700 transform hover:scale-105 active:scale-95 transition-all duration-200 shadow-lg shadow-blue-500/30 hover:shadow-xl hover:shadow-blue-500/40"
                >
                  🚀 Start This Step
                </button>
              )}
