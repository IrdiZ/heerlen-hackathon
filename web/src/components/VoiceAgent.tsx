    ...
    <div className="flex flex-col items-center gap-6">
      ...
      {conversation.status !== 'connected' ? (
        <button
          onClick={handleStart}
          disabled={isStarting}
          className="px-8 py-4 text-xl font-semibold text-white bg-blue-600 rounded-full hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all transform hover:scale-105 shadow-lg"
        >
          {isStarting ? (
        ...
        <button
          onClick={handleStop}
          className="px-8 py-4 text-xl font-semibold text-white bg-red-600 rounded-full hover:bg-red-700 transition-all transform hover:scale-105 shadow-lg"
        >
          <span className="flex items-center gap-2">
            <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
