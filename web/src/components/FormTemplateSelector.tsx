    ...
    <div className="bg-white rounded-xl shadow-lg p-6">
        ...
        <div className="mb-4 p-3 bg-orange-50 border border-orange-200 rounded-lg">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="px-3 py-1 text-sm font-medium text-orange-600 bg-orange-100 rounded-lg hover:bg-blue-200 transition-colors"
            >
              Use this template
            </button>
          </div>
      ...
      <div className="mb-4">
        ...
        <select
          ...
          className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none bg-white"
        >
...
export function TemplateIndicator({
  ...
  return (
    <button
      onClick={onClick}
      className="inline-flex items-center gap-2 px-3 py-1.5 bg-orange-50 text-orange-700 rounded-full text-sm font-medium hover:bg-orange-100 transition-colors"
    >
